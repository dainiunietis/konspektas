...
@function _harmony-weight(
  ...
  $white-bright: tallysLumen-brightness(#fff);
  $color-bright: tallysLumen-brightness($color);
  $harmony-bright: tallysLumen-brightness($harmony);
...
@function harmonize(
  ...
  @if type-of($harmony) != 'color' {
    ...
    @if function-exists($harmony) {
      // $harmony: call($harmony, $color); //orig
      $harmony: call(get-function($harmony), $color); //~zm~
    }
